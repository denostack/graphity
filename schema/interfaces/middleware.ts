...
export type MiddlewareNext<TSource = any, TContext = any, TArgs = Record<string, any>> = (
  nextCarry?: Partial<MiddlewareCarry<TSource, TContext, TArgs>>,
) => any;
...
export type MiddlewareClass<TSource = any, TContext = any, TArgs = Record<string, any>> = new (
  ...args: any[]
