...
describe("@graphity/container, container/Container", () => {
  ...
  it("test error message stack by resolver", async () => {
    ...
    expect(error4).toBeInstanceOf(UndefinedError);
    expect(error4.message).toEqual(
      '(anonymous class) is not defined!\nresolve stack: "resolver4" -> (anonymous class)',
    );
  ...
  it("test error message stack by resolver", async () => {
    ...
    class Bind1 {
      public constructor(@Inject(stack1[1]) public param: any) {}
    }
    ...
    class Bind2 {
      public constructor(@Inject(stack2[1]) public param: any) {}
    }
    ...
    class Bind3 {
      public constructor(@Inject(stack3[1]) public param: any) {}
    }
    ...
    class Bind4 {
      public constructor(@Inject(stack4[1]) public param: any) {}
    }
