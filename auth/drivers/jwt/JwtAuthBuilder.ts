...
import { AuthBuilder, CreateTokenOptions, GraphityAuth, UserIdentifier } from "../../../interfaces/auth";
...
export class JwtAuthBuilder<TUser extends UserIdentifier = UserIdentifier, TRole extends string = string>
  extends AuthBuilder<TUser, TRole> {
  constructor(
